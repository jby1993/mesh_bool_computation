...
protected:
    ...
    void fill_vbo_edge_topology_data(RenderModes * pRenderModes);
    void fill_vbo_face_topology_data(RenderModes * pRenderModes);


    void fill_vbo_vertex_color_data(RenderModes* pRenderModes);
    void fill_vbo_edge_color_data(RenderModes* pRenderModes);
    void fill_vbo_face_color_data(RenderModes* pRenderModes);

    Vec4 get_vertex_render_color(RenderModes* pRenderModes, int vid);


    void fill_vertices_and_normals_by_face_indices(const Vec3i& indices, std::vector<float>& vertices, std::vector<float> &normals);
    void fill_colors_by_face_indices(const Vec3i& indices, RenderModes* pRenderModes, std::vector<float>& colors, bool is_selected);
